...
if __name__ == "__main__":
    ...
    patient_openface_feature_root_dir = (
        rf"{data_root_dir}\hxq\test\video_subclip_patient"
    )

    normal_openface_feature_root_dir = (
        rf"{data_root_dir}\hxq\test\video_subclip_doctor"
    )
    ...
    csv_path = rf"{dataset_root_dir}\test\clipped_data\user_info.csv"

    save_user_base_info_to_csv(csv_path, user_base_info)

    users_feature_dir = rf"{dataset_root_dir}\test\clipped_data"
